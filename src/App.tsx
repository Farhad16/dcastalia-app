  ...
  return (
    <div className="relative overflow-hidden">
      <div className="flex flex-col">
        ...
        <div className="bg-indigo-900 flex flex-col min-h-[550px] p-[80px] pt-[150px]">
          <div className="flex w-[40%] gap-4">
            <button
              onClick={prevSlide}
              disabled={currentSlide === 0}
              className="pt-[2px] pb-[4px] px-[8px] border rounded-full text-white hover:bg-white hover:text-black outline-none focus:outline-none transition duration-300 ease"
            >
              &#8592;
            </button>
            <button
          ...
          <div className="flex items-center justify-center flex-col pt-[150px]">
            ...
            <p className="text-white text-center mt-2 w-[70%]">
              ...
              animi harum vero doloribus dolores exercitationem voluptatem saepe
              iste temporibus odio, ipsa eos voluptate adipisci incidunt.
            </p>
          </div>
        </div>
      </div>
